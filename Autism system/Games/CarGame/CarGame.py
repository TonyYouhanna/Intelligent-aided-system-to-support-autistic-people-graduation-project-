...
def cargame():
    ...
    background = pygame.image.load("Games/CarGame/image/map.jpg")
    background1 = pygame.image.load("Games/CarGame/image/background1.jpg")
    background2 = pygame.image.load("Games/CarGame/image/background2.jpg")
    clock = pygame.time.Clock()

    img1 = pygame.image.load("Games/CarGame/image/car1.jpg")
    ...
    def obstacle(obs_startx, obs_starty, obs):
        if obs == 0:
            obs_pic = pygame.image.load("Games/CarGame/image/car2.jpg")
        elif obs == 1:
            obs_pic = pygame.image.load("Games/CarGame/image/car3.jpg")
        elif obs == 2:
            obs_pic = pygame.image.load("Games/CarGame/image/car4.jpg")
        elif obs == 3:
            obs_pic = pygame.image.load("Games/CarGame/image/car5.jpg")
        elif obs == 4:
            obs_pic = pygame.image.load("Games/CarGame/image/car6.jpg")
        elif obs == 5:
            obs_pic = pygame.image.load("Games/CarGame/image/car7.jpg")
        elif obs == 6:
            obs_pic = pygame.image.load("Games/CarGame/image/car8.jpg")
        ...
        while running:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    pygame.quit()
                    return
            t = Games.CarGame.demo.run(face_mesh, cap)
            print(t)
