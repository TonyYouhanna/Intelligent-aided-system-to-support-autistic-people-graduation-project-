...
def spinGame():
    ...
    text = canvas.create_text(WIDTH * 4 / 5, 10, fill="darkblue", font="Times 20 italic bold",
                              text="Player: {}".format(player_name))
    ...
    with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            try:
                ...
                head = [WIDTH * (1 - landmarks[mp_pose.PoseLandmark.NOSE.value].x),
                        HEIGHT * landmarks[mp_pose.PoseLandmark.NOSE.value].y]

                L_hand_mid = [WIDTH * (1 - landmarks[mp_pose.PoseLandmark.LEFT_ELBOW].x),
                              HEIGHT * landmarks[mp_pose.PoseLandmark.LEFT_ELBOW.value].y]
                L_hand_end = [WIDTH * (1 - landmarks[mp_pose.PoseLandmark.LEFT_WRIST.value].x),
                              HEIGHT * landmarks[mp_pose.PoseLandmark.LEFT_WRIST.value].y]

                R_hand_mid = [WIDTH * (1 - landmarks[mp_pose.PoseLandmark.RIGHT_ELBOW].x),
                              HEIGHT * landmarks[mp_pose.PoseLandmark.RIGHT_ELBOW.value].y]
                R_hand_end = [WIDTH * (1 - landmarks[mp_pose.PoseLandmark.RIGHT_WRIST.value].x),
                              HEIGHT * landmarks[mp_pose.PoseLandmark.RIGHT_WRIST.value].y]

                L_leg_mid = [WIDTH * (1 - landmarks[mp_pose.PoseLandmark.LEFT_KNEE].x),
                             HEIGHT * landmarks[mp_pose.PoseLandmark.LEFT_KNEE.value].y]
                L_leg_end = [WIDTH * (1 - landmarks[mp_pose.PoseLandmark.LEFT_ANKLE.value].x),
                             HEIGHT * landmarks[mp_pose.PoseLandmark.LEFT_ANKLE.value].y]

                R_leg_mid = [WIDTH * (1 - landmarks[mp_pose.PoseLandmark.RIGHT_KNEE].x),
                             HEIGHT * landmarks[mp_pose.PoseLandmark.RIGHT_KNEE.value].y]
                R_leg_end = [WIDTH * (1 - landmarks[mp_pose.PoseLandmark.RIGHT_ANKLE.value].x),
                             HEIGHT * landmarks[mp_pose.PoseLandmark.RIGHT_ANKLE.value].y]
            ...
            if draw_man == TRUE:
                ...
                hairs = canvas.create_arc(head_x1, head_y1, head_x2, head_y2 - 3 * eye_size, start=0, extent=180,
                                          fill="black")
                ...
                Lh_fingures = canvas.create_oval(Lh_fingure_x1, Lh_fingure_y1, Lh_fingure_x2, Lh_fingure_y2,
                                                 fill="black")
                Rh_fingures = canvas.create_oval(Rh_fingure_x1, Rh_fingure_y1, Rh_fingure_x2, Rh_fingure_y2,
                                                 fill="black")
                ...
                Ll_fingures = canvas.create_oval(Ll_fingure_x1, Ll_fingure_y1, Ll_fingure_x2, Ll_fingure_y2,
                                                 fill="black")
                Rl_fingures = canvas.create_oval(Rl_fingure_x1, Rl_fingure_y1, Rl_fingure_x2, Rl_fingure_y2,
                                                 fill="black")

                # Body parts -----------------------------------------------------------------------------------------------------
                Body_parts = [head, hairs, smile, neck, L_eye, R_eye, body, Left_hand_mid, Left_hand_end,
                              Right_hand_mid,
            ...
            if pos_stick_1[1] <= pos_ball[3]:
                if pos_stick_1[0] <= pos_ball[2] and pos_stick_1[2] >= pos_ball[0]:
                    ...
                    if score >= 10:
                        ...
                        try:
                            loading("audio/spinball2.mp3", "photos_GUI/last.gif", 6000, 28, 30)
                    ...
                    if score <= -10:
                        ...
                        cv2.destroyAllWindows()
                        try:
                            loading("audio/spinball1.mp3", "photos_GUI/last.gif", 6000, 28, 30)
            ...
            text = canvas.create_text(100, 10, fill="darkblue", font="Times 20 italic bold",
